        ...
        internal class Program
        {
                ...
                IList<Personaggio> personaggi = new List<Personaggio>()
            {
                ...
                //3° lamba serve per proiettare le coppie risultanti nel modo che ci interessa
                    ...
                    .Select(t=>t.o).ToList(); //lista delle opere di picasso 
                ...
                // System.Console.WriteLine("raggruppamento per nazionalità spangola");
            
                    //gruppo spagna

                    // var gruppoEsp=artisti.Where(a=>a.Nazionalita=="Spagna").ToList();
                    // gruppoEsp.ForEach(Console.WriteLine);

                    // int gruppoEspCount=gruppoEsp.Count();
                    // System.Console.WriteLine($"ci sono {gruppoEspCount} artisti spagnoli");

                    // //gruppo italia

                    // System.Console.WriteLine("raggruppamento per nazionalità italiana");
                    // var gruppoIta=artisti.Where(a=>a.Nazionalita=="Italia").ToList();
                    // gruppoIta.ForEach(Console.WriteLine);

                    // int gruppoItaCount=gruppoIta.Count();
                    // System.Console.WriteLine($"ci sono {gruppoItaCount} artisti italiani");


                    // System.Console.WriteLine("raggruppamento per nazionalità francese");
                    // var gruppoFra=artisti.Where(a=>a.Nazionalita=="Francia").ToList();
                    // gruppoFra.ForEach(Console.WriteLine);

                    // int gruppoFraCount=gruppoFra.Count();
                    // System.Console.WriteLine($"ci sono {gruppoFraCount} artisti francesi");
